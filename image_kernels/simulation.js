...
function update() {
    ...
    drawImageScaled(einstein_image, left_context);
...
function initParams() {
    ...
    // // edge detection 1
    // // kernel_matrix = [[1, 0, -1], [0, 0, 0], [-1, 0, 1]];

    // // edge detection 2
    // // kernel_matrix = [[0, -1, 0], [-1, 4, -1], [0, -1, 0]];

    // // edge detection 3
    // // kernel_matrix = [[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]];

    // // box blur
    // // kernel_matrix = [[1/9, 1/9, 1/9], [1/9, 1/9, 1/9], [1/9, 1/9, 1/9]];

    // // gaussian blur
    // // kernel_matrix = [[1/16, 2/16, 1/16], [2/16, 4/16, 2/16], [1/16, 2/16, 1/16]];
