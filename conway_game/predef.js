...
function gliderState() {
  num_cells = 16; initCanvas();toggle(1,6);toggle(2,4);toggle(2,6);toggle(3,5);toggle(3,6);alwaysResume();
}

function lwssState() {
  num_cells = 10; initCanvas();toggle(1,3);toggle(1,5);toggle(2,6);toggle(3,6);toggle(4,3);toggle(4,6);toggle(5,4);toggle(5,5);toggle(5,6);alwaysResume();
}

function hwssState() {
  num_cells = 15; initCanvas();toggle(3,7);toggle(3,8);toggle(3,9);toggle(4,6);toggle(4,9);toggle(5,9);toggle(6,5);toggle(6,9);toggle(7,5);toggle(7,9);toggle(8,9);toggle(9,6);toggle(9,8);alwaysResume();
}
